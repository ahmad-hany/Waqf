...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2019 at 04:13 PM
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `Service_ID_FK` FOREIGN KEY (`AppointmentNo`) REFERENCES `services` (`ServiceID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `events`
--
ALTER TABLE `events`
  ADD CONSTRAINT `Post_ID_events_FK` FOREIGN KEY (`EventID`) REFERENCES `post` (`PostID`);

--
-- Constraints for table `rate`
--
ALTER TABLE `rate`
  ADD CONSTRAINT `Service_ID_rate_FK` FOREIGN KEY (`RateID`) REFERENCES `services` (`ServiceID`);
COMMIT;
